...
$form.Text = 'Enter some information' ### Text to be displayed in the title
...
$label.AutoSize = $True
$Font = New-Object System.Drawing.Font("Arial",10,[System.Drawing.FontStyle]::Bold) ### Formatting text for the label
$label.Font = $Font
