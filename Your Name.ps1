...
$OKB.Text = "Submit"
$OKB.Add_Click({Write-Host "Entered Name is"$OTB.Text -ForegroundColor Green;$inputform.Close()})
...
$CAB.Text = "Clear"
$CAB.Add_Click({Write-Host "No input Name from user" -ForegroundColor Red;$inputform.Close()})
