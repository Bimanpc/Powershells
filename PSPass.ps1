...
Description = 'Microsoft Azure PowerShell By PCTEGHGREUUA - Accounts credential management cmdlets for Azure Resource Manager in Windows PowerShell and PowerShell Core.
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAIJrm4Mh7Qrubw
# CejcCiXpeWRGETbN2mOSm8Zj+opXnKCCDYEwggX/MIID56ADAgECAhMzAAACUosz
# 4pNdBCaG0qRlfMPrZ4w48L5n6qk0
